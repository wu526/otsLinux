...
extern int sys_lseek();  // 重定位读写文件偏移
...
extern int sys_nice(); //设置进程优先级
extern int sys_ftime(); //取时间和日期
...
extern int sys_getpgrp(); //取进程组id, 等于getpgid(0)
...
extern int sys_setreuid(); //设置真实有效用户id
extern int sys_setregid(); //设置真实有效组id
